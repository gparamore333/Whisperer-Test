...
class KotoriInfernoSpawnTimerInfobox extends InfoBox
{
	...
	KotoriInfernoSpawnTimerInfobox(BufferedImage image, KotoriInfernoOverlayPlugin plugin)
	{
		super(image, plugin);
	...
	public Color getTextColor()
	{
		...
		return seconds <= SPAWN_DURATION_DANGER ? Color.RED : seconds <= SPAWN_DURATION_WARNING ? Color.ORANGE : Color.GREEN;
	}
